...
def index(request):
    print('in the parent page')
    return render(request, 'templatesApp/movies.html', {'movie': movies})

def details(request):
    print('in the details page')
    return render(request, 'templatesApp/movie_details.html', {'moviedetails': movies.movie_details})

def synopsis(request):
    print('in the synopsis page')
    return render(request, 'templatesApp/movie_synopsis.html', {'moviesynopsis'})
